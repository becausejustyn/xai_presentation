...
## XAI Challenges I: technique limitations
...
::: notes
Adversarial attacks: Deliberate modifications to input data to deceive machine learning models, that are not noticable to humans.
:::

------------------------------------------------------------------------

## XAI Challenges II: human focused
...
-   Similarly, the general purpose of XAI is to help human users better understand non human features. Many limitations have occured from not considering the human element. Such as
...
## XAI Challenges III: User Studies
...
-   this is where challenge of subjective vs objective measures in user studies can go?
...
-   Mention how you used yaw position and skin tone for creating different datasets, then during those slides you talk about it without text on those slides?
-   XAI used? where should that go
...
-   Similarly, to categorise skin tone, the Fitzpatrick classification system was used [@fitzpatrick1988validity], where the middle group was removed to make it slightly more clear.
...
-   For all conditions the sex and proportion of skin tones of the rendered human id was balanced
-   Mention the model architecture, they were pretrained, etc. and that you used a cropping model too and resized the images
...
-   how you evaluated the tasks of the participants (might be where you talk about the IV)
...
::: {style="display: flex; justify-content: center;"}
![Example Trial](images/xai_study_example.png){alt="Example Trial" fig-align="center" width="60%"}
:::
