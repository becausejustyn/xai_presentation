...
## User Evaluation of XAI

::: {#fig-elephants layout-ncol="2"}
![XAI Help User Understanding](images/xai_help_und1.png){#fig-surus}

![User Confidence in XAI](images/xai_conf1.png){#fig-hanno}
...
- @shen2020useful found that XAI may help users recognise features, but is limited by humans ability to understand the explanation.
- @alqaraawi2020evaluating too found there was an improvement in a users ability to recognise features, but the impact was quite limited.

------------------------------------------------------------------------

## Conclusion

-   Post-hoc visualisations are one part of XAI. 
-   Transparency (e.g. methods) side of XAI is potentially more important, yet gets often neglected.
-   A key element in XAI is the human user. 
-   Visualsing example.

::: notes
Future research?  
Ask audience to visualise a sandwich, then ask them if it was a hotdog? Use this as an example of why we need a consensus on terminology. 
:::
