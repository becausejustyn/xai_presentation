...
-   The user was provided with an **input image**, the **predicted person**, and an explanation from two difference models, asking the user to select which XAI they find to be more reasonable.
...
-   Made the study available to participants from either Australia, United States, or United Kingdom.
-   Prior running the experiment, a pilot study of 10 participants was used.
-   The sample size for the experiment was 40, broken down from the following countries:
    -   Australia 7
    -   United Kingdom 23
    -   United States 10
